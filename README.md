...
- **Wishlist dans le profil** — liste complète de ta wishlist Steam (tous les jeux, pas seulement ceux déjà sortis), triée par date de sortie quand elle est connue (plus proche en haut), avec miniature, nom et badge coloré (vert = sorti, orange = bientôt, gris = date lointaine ou inconnue). N'afficher que les jeux déjà sortis est le rôle du panneau Échéances ci-dessus.
