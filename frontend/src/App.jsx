    ...
    <>
      ...
      <div style={{ padding: '14px 14px 12px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', flexShrink: 0 }}>
          ...
          <img src="https://cdn.discordapp.com/icons/983316258302877747/ebcf20448ef8818f93e8f31afad9f8d9.png" alt="" style={{ width: 19, height: 19, borderRadius: '50%', marginLeft: -6, position: 'relative', zIndex: 2, border: '2px solid #111' }} />
        </div>
