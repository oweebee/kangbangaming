...
function TabFeatures() {
  const features = [
    ...
    { icon: '📊', title: 'Onglet Stats du profil', desc: 'Onglet dédié entre "Profil" et "Corbeille" : boards, boards publics, nombre réel de jeux dans ta bibliothèque Steam, cartes perso, nombre réel de jeux dans ta wishlist Steam, jeux avec échéance, notes écrites, boards publics suivis, board le plus actif, ancienneté du compte.' },
