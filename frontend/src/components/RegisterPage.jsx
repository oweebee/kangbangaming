    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div>
            <label style={{ display: 'block', fontSize: 12, color: 'var(--text-muted)', marginBottom: 6 }}>Nom d'utilisateur <span style={{ color: 'var(--text-muted)', fontWeight: 400 }}>(min. 3 caract.)</span></label>
            <input
          ...
          <div>
            <label style={{ display: 'block', fontSize: 12, color: 'var(--text-muted)', marginBottom: 6 }}>Mot de passe <span style={{ color: 'var(--text-muted)', fontWeight: 400 }}>(min. 6 caract.)</span></label>
            <input
        ...
        <div style={{ marginTop: 20, textAlign: 'center', fontSize: 13, color: 'var(--text-muted)' }}>
          Déjà un compte ?{' '}
          <button onClick={onGoLogin} style={{ background: 'none', border: 'none', color: 'var(--accent)', cursor: 'pointer', fontWeight: 600, fontSize: 13, padding: 0 }}>
            Se connecter
          </button>
        </div>
      </div>
